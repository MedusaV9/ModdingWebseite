...
test('thumb upload: sets thumbUrl, broadcasts photo_updated, raw fetch via header only', async (t) => {
  ...
  // Raw bytes via Authorization header; query credentials are rejected.
