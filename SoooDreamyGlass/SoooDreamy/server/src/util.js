...
/** Lowercase hex SHA-256 of a UTF-8 string (commit-reveal verification). */
export function sha256Hex(text) {
  return crypto.createHash('sha256').update(text, 'utf8').digest('hex');
}

/** Random positive 31-bit seed for game payloads (fits every JSON int parser). */
export function newSeed() {
  return 1 + crypto.randomInt(2_147_483_646);
}
