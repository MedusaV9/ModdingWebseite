...
## W18/B5: net_client.gd attacht beim Boot EAGER (build_services) — ein
## MAIL_NEW-Push vor dem ersten UI-attach ging sonst verloren (unread blieb
## 0, keine Ungelesen-Kapsel am Post-Schalter). Spätere attach()-Rufe der
## UI liefern idempotent dieselbe Instanz.
