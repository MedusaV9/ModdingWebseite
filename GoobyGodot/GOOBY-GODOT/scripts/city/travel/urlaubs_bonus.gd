...
class WeltengoobyKarte:
	...
	## Karten-CanvasLayer: ÜBER Raum-HUD (5) und Home-HUD (UiLayer 10) —
	## sonst bleiben HUD-Knöpfe über dem Schleier sichtbar UND tappbar;
	## unter Quest-Toasts (60), Guide (70) und RewardHub (90). W19-Playtest-
	## Falle „CanvasLayer ohne layer“ (Default 1) — Muster HeimkehrMoment.
