...
## J3 „Läden lebendig 2“: 2 Stations-Gäste schweben zwischen den
## Terminals umher (bewusst ohne Glöckchen/Gemurmel — im Orbit ist es
## still; keine Kasse, der Automat verkauft von selbst).
