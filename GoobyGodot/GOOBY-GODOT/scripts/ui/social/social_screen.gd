...
## pro Freund „Besuchen“, „Schiffe versenken“ und „GoobyPal“. (Der alte
## W2d-Vollbild-Freunde-Screen ist gelöscht — Code/Anfragen wohnen produktiv
## in der Handy-Freunde-App, EVAL-2026-08 C §6.3.) Behandelt
...
func _ready() -> void:
	...
	_wire_services()
	_refresh_all()
	_refresh_focus_navigation.call_deferred()
...
func _build_ui() -> void:
	...
	_practice_btn.focus_mode = Control.FOCUS_ALL
...
func _build_friend_row(row: Dictionary) -> Control:
	...
	visit_btn.focus_mode = Control.FOCUS_ALL
	...
	board_btn.focus_mode = Control.FOCUS_ALL
	...
	chess_btn.focus_mode = Control.FOCUS_ALL
	...
	pal_btn.focus_mode = Control.FOCUS_ALL
...
func _add_incoming_card(
	...
	yes.text = yes_text
	yes.focus_mode = Control.FOCUS_ALL
