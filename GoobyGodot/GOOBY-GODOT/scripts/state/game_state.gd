...
const DEFAULT_SLICE_SCRIPTS := {
	...
	# W18/B1 (FIX-G2): der Ranch-KAUF läuft im Hub/an der Landstraße, BEVOR
	# je eine Ranch-Szene lädt — ohne Boot-Registrierung fehlte
	# `state["ranch"]` und der Kauf crashte NACH der Abbuchung (2500 ᴳ weg
	# ohne Leistung, Doppelkauf möglich). Gleiche Lücke wie einst `city`.
	"ranch": "res://scripts/ranch/ranch_state.gd",
	# W19/McGooby-B: der McGooby-KAUF läuft ebenfalls im DLC-Hub, bevor je
	# eine McGooby-Szene lädt — gleiche W18/B1-Lehre wie `ranch`.
	"mcgooby": "res://scripts/dlc/mcgooby/mcgooby_state.gd",
}
