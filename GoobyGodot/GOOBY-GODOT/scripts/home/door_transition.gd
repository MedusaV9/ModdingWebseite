...
func _exit_tree() -> void:
	...
	if _open_tween != null and _open_tween.is_valid():
		_open_tween.kill()
	# Ein kill() sendet Tween.finished nicht. Den eigenen Waiter explizit
	# lösen, damit weder _open_panel noch travel als FunctionState leaken.
	oeffnen_beendet.emit()
...
func _open_panel() -> void:
	...
	_open_tween.finished.connect(_on_oeffnen_beendet, CONNECT_ONE_SHOT)
	await oeffnen_beendet
	_open_tween = null


func _on_oeffnen_beendet() -> void:
	oeffnen_beendet.emit()
