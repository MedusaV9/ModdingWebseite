...
export const de = {
  ...
  modDetail: {
    ...
    moreMods: 'MEHR MODS',
    moreBy: (author: string) => `MEHR VON ${author} →`,
  },
  modes: {
    eyebrow: 'MEHR ARTEN ZU SPIELEN',
    title: 'SPIELMODI & TRACKS',
  ...
  modders: {
    ...
    gallery: {
      ...
      title: 'KARTEN-EFFEKTE GALERIE',
      subtitle:
        'Der Launcher unterstützt 28 Karten-Presets über visual.preset — hier sind alle, live gerendert in purem CSS. Wähl ein Swatch, um es auf der Testkarte zu sehen.',
      tryAll: 'ALLE 28 LIVE IN DER GALERIE TESTEN ↓',
      chooseLabel: 'Preset wählen',
      testCardTitle: 'EFFEKT-TESTKARTE',
      testCardSummary:
        'Eine Fake-Mod-Karte — so sieht deine BAPHub-Karte mit dem gewählten Preset aus.',
      testCardBadges: ['PREVIEW', 'QOL', 'V1.0.0'],
      copy: 'KOPIEREN',
      copied: 'KOPIERT!',
      hiddenNote:
        'Jeder Effekt-Token hat auch eine hidden_<token>-Variante, die den Effekt anwendet, ohne den sichtbaren Tag-Chip zu zeigen.',
      // 17 davon stammen (fast wörtlich) aus der Authoring-Doku des Launchers.
      descriptions: {
        default: 'Schlichte Standardkarte, ohne Extras.',
        featured: 'Amber-Highlight mit langsamem Glow-Puls.',
        shiny: 'Cleaner diagonaler Schimmer — dezenter Specular-Glanz.',
        holo: 'Holografischer Regenbogen-Schimmer, dezent.',
        neon: 'Pinker Neon-Glow, kräftig und laut.',
        frost: 'Blasser Eis-Verlauf mit vereister Oberkante.',
        ember: 'Aufsteigende Glut — warmes Flackern von unten.',
        prism: 'Regenbogen-Facetten, langsam wandernd.',
        glitch: 'RGB-Split und Jitter, digitaler Error-Style.',
        aurora: 'Weiches Grün/Teal/Violett-Nordlicht.',
        frozen: 'Starker Ice-Look, kalt und kristallig.',
        plasma: 'Violett und elektrisch, energiereich.',
        toxic: 'Grün/Acid, radioaktiver Stil.',
        cosmic: 'Tiefer Space-Look mit breiten Farbnebeln.',
        vapor: 'Pink/Cyan Retro-Wave.',
        storm: 'Dunkler Elektro-Storm-Look.',
        inferno: 'Heißer Rot/Orange-Flare.',
        velvet: 'Dunkler violetter Soft-Glow.',
        matrix: 'Digitales Grün mit Scanline-Charakter.',
        ghost: 'Bleich, transluzent und leise.',
        crystal: 'Cyan-Blau, sauberer Kristall-Glanz.',
        chrome: 'Metallisch/Silber.',
        noir: 'Dunkler Low-Gloss-Look.',
        sunset: 'Orange/Pink Abend-Gradient.',
        void: 'Dunkler Deep-Space-Stil.',
        candy: 'Bunter Sweet-Pop-Look.',
        dev: 'Gestrichelter Terminal-Look für Dev-Builds.',
        event: 'Party-Streifen und Konfetti für Events.',
      },
    },
    validation: {
  ...
  community: {
    ...
    sub: 'MOD-DROPS ✕ PLAYTESTS ✕ SPEEDRUNS ✕ DEV-TALK',
    discordCta: 'DISCORD.GG/BAPBAPMODS',
    modCount: (n: number) => `${n} Mods auf BAPHub`,
    allTheirMods: 'ALLE IHRE MODS →',
    trailer: {
