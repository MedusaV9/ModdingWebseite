...
.g12-wr-item{position:relative;display:flex;flex-direction:column;align-items:center;gap:0.25rem;min-width:0;border:0.1875rem solid transparent;border-radius:var(--card-radius);background:var(--white);box-shadow:var(--shadow-soft);font-family:inherit;color:var(--brown);cursor:pointer;padding:0.5rem 0.25rem 0.625rem;-webkit-tap-highlight-color:transparent;transition:transform 90ms ease;}
