...
with fxlib. FX-WAVE-13 team A3 pass ("Ferryman/Arena/Tagesriss") layered on top:
  ...
  (moved out, F-102)          eclipse:day_rift_maw + eclipse:day_rift_dust_puff are now
                              authored by `tools/photon/rift_mass_fx.py` (RIFT-MASS team
                              B pass: multi-shell throat, dark core, emissive rim).
...
# day_rift_dust_puff.fx / day_rift_maw.fx moved to rift_mass_fx.py (F-102).
BUILDERS = {
