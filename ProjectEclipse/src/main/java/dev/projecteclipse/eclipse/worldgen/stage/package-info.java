 ...
 * {@link dev.projecteclipse.eclipse.worldgen.stage.FusionSequence} is the special
 * stage 0 → 1 intro sweep where the main disc and the eight player discs fuse into one
 * (distance-to-nearest-edge ordering, rumble + camera-shake pulses).
