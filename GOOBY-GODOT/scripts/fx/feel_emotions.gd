...
##  sfx:     SfxMap-Id ("" = stumm) — seit G6-FEEL hat jede Emotion ihr
##           eigenes emo_*-Mini-Motiv (tools/audio/g6_gen_feel_sfx.py)
##           statt recycelter UI-Sounds, dauer_s: Anzeigedauer,
