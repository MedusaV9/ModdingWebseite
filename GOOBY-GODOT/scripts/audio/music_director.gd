...
func _ready() -> void:
	...
	# W18/J5: Klangbett-Bootstrap (Orts-Ambience-Betten) — der Knoten hängt
	# sich selbst an SceneRouter.travel_finished; ohne Reisen bleibt er still.
	Klangbett.get_or_create(self)
...
func play_stinger(track_id: String) -> void:
	...
	# W18/J5: das Orts-Klangbett duckt für die Jingle-Dauer weich weg.
	Klangbett.melde_stinger(self, stream.get_length())
