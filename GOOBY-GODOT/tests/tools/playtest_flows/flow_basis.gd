...
func onboarding_schritte() -> Array[Dictionary]:
	return [
		...
		# W18/J1 Morgen-Ritual: der Overlay-Dirigent zeigt die Willkommens-
		# Overlays NACHEINANDER — erst begrüßt Gooby (Vorlauf), dann gleitet
		# das Tagesbonus-Blatt rein, dann der Coachmark, dann kehrt die
		# Guide-Tour-Karte zurück. Die Schritte folgen dieser Reihenfolge.
		{
		...
		# Erste-Viertelstunde-Tour (OnboardingGuide, "Schritt 1/9") kommt nach
		# der Sequenz zurück — wie ein Spieler, der lieber frei spielt: X.
		{
