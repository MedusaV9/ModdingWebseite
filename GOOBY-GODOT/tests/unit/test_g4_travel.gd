...
func test_weltengooby_feier_als_karte() -> void:
	...
	# W19-Playtest-Falle „CanvasLayer ohne layer“: die Feier-Karte MUSS über
	# Raum-HUD (5) und Home-HUD (UiLayer 10) liegen — sonst bleiben
	# HUD-Knöpfe über dem Schleier sichtbar UND tappbar (Muster Heimkehr).
	...
	assert_eq(
		...
		UrlaubsBonus.WeltengoobyKarte.KARTEN_LAYER,
