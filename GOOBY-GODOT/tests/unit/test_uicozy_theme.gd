...
func test_toast_bubble_variation() -> void:
	...
	# W21 P1: Blatt-Sprache — Radius liegt auf der Skala (RADIUS_CARD),
	# die alte 22er-Web-Parität ist Geschichte.
	assert_eq(sb.corner_radius_top_left, AcTokens.RADIUS_CARD, ".toast: RADIUS_CARD")
