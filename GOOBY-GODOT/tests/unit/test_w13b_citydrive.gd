...
## W21/P4-Fix (Flaky-Wurzel): Energie auffüllen UND das 150-c-Tages-Ledger
## der Timed-Minigame-Coins (minigame_award._book_minigame_day_coins) leeren.
## Der geteilte GameState sammelt über frühere Suite-Tests mit echten
## Host-Runden dayCoins an — steht das Ledger beim Start dieses Tests am
## Deckel, zahlt der Award 0 Münzen und „Münzen werden trotz Teleport
## gebucht“ kippt (Suite-Reihenfolge-abhängig; Isolations-Muster wie
## test_w20_arcade_fortschritt, die Assertion selbst bleibt unverändert).
