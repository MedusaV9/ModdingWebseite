...
_(leer — hier neue Punkte reinschreiben; zuletzt gezogen: 31.07. ~17:35 UTC — keine neuen Einträge; M-C visuell abgenommen, Glitch-Shader-Regression gefixt, jetzt F-096-Rest + Eval-Runde)_
...
| F-101 | **Nach-Polish-Welle** (4 parallele Fable-5-Teams): T1 FX-Kopplungen (star_call/flicker/smear echt bauen), T2 Action-Blend-System (versionierter FROZEN-Contract, 2–4-Tick-Blends nur wo sinnvoll, Horror-Snaps bleiben hart), T3 Hand-3D-Items (BEWLR: 3D in Hand, finale Pixel-Art im GUI), T4 `/eclipsefx storm flashhold` + Perf-Probe für B6/V6-Abnahme; danach Client-Acceptance-Pass | 🟡 |
