...
_(leer — hier neue Punkte reinschreiben; zuletzt gezogen: 31.07. ~23:45 UTC — keine neuen Einträge; F-102-Acceptance komplett (A/B/C visuell, D serverseitig per Team-Skript inkl. Leak-Gate), als Nächstes: Polish-Welle 3)_

## Aktuell in Arbeit

| # | Punkt | Status |
|---|-------|--------|
| F-103 | **Polish-Welle 3** (3 parallele Fable-5-Max-Thinking-Teams): **A** FX-Respawn-Hygiene — „Duplicate fx runtime object id"-Sturm ausrotten (Beleg: 1296 Client-Warnungen, 10 UUIDs, 4 davon je 222× ersetzt; Bursts beim Struktur-Flight-Fenster + Teleport in die Altar-Zone ⇒ ein Server-Pfad re-sendet verankerte Spawns pro Tick statt Loop-Keepalive), **B** Credits-Restrisiken aus dem D-Report — Effigy-10t-Burst phase-slicen (Risiko 2) + Sky-Drain-Dome-Quads vs. Kamera absichern (Risiko 3), **C** neue Veil×Photon-Effekte aus den IDEAS-Katalogen (2–3 unverbaute Momente production-grade: Generator + Rows + Cues, alle Haus-Gesetze) | 🟡 |
