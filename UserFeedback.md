...
_(leer — hier neue Punkte reinschreiben; zuletzt gezogen: 31.07. ~19:35 UTC — keine neuen Einträge; F-101-Acceptance-Pass fertig (alle 4 Teams in-game abgenommen, 1 Live-Crash dabei gefunden+gefixt), als Nächstes: nächste Polish-Welle)_

## Aktuell in Arbeit

| # | Punkt | Status |
|---|-------|--------|
| F-102 | **Polish-Welle 2** (4 parallele Fable-5-Max-Thinking-Teams, je Planner→Ideen→Implement→Selbst-Iteration): **A** Glitch-Zonen-Shader-Familie einzeln tiefenpolieren (invert/datamosh/outline/scanlines/void/dome/dome_shell/end_static — frisch entstorben in F-100, nie einzeln poliert; mehr Verschiedenheit pro Effekt, Farb-Parameter sauber durchziehen), **B** Rift-Volumetrik („Rifts sind nur Scheiben" → Masse/Tiefe: Tagesriss + Struktur-Rifts + rift_glitch-Shader), **C** Nether-Öffnung Tag 2 Masse-Pass (Vor-Eruptions-Beats lesbarer, Boden-Beben, Rauch-Feuer-Dauerwolke dicker), **D** Credits-Finale „Tausende-Displays"-Scale-up (Insel/Altar-Zersplitterung, Display-Budget-Leiter, Schwarzloch-Verschlingen dichter); danach Integration-Gate + Client-Acceptance | 🟡 |
