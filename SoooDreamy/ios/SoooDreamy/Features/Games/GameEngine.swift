...
/// Tiny deterministic PRNG so both clients derive the exact same question
/// order from the shared seed. Swift's own RNG (and `.shuffled()`) is NOT
/// deterministic across devices or launches.
